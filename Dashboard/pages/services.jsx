        ...
        <div className="flex flex-col">
          ...
          <main className="flex-1 space-y-4 p-4 md:p-6">
            ...
            <Card>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell>
                        ...
                        <div className="text-sm text-muted-foreground">Home Appliances</div>
                      </TableCell>
                    ...
                    <TableRow>
                      <TableCell>
                        ...
                        <div className="text-sm text-muted-foreground">Gardening</div>
                      </TableCell>
                      <TableCell>100</TableCell>
                      <TableCell>$9,900.00</TableCell>
                    </TableRow> */}
                  {services.map(service => {
                    return <>
                    <TableRow>
                      <TableCell>
                        <div className="font-medium">{service.metric.service}</div>
                        {/* <div className="text-sm text-muted-foreground">Gardening</div> */}
                      </TableCell>
                      <TableCell>{service.metric.cluster_ip}</TableCell>
                      <TableCell>{service.metric.namespace}</TableCell>
                    </TableRow>
                    </>
                  })}
                  </TableBody >
              ...
              {/* <CardFooter className="text-sm text-muted-foreground">Top 3 products by sales</CardFooter> */}
            </Card>
            </div>
          </main>
        </div>
